...
$(document).ready(function() {
              ...
              if (data != ""){
                  ...
                  for(i=0;i<data.length;i++){
                    ...
                    for(j=1;j<8;j++){
                      ...
                      html += '<td id="'+j+'-on"><input type="text" name="time'+j+'-on" id="time" class="time" onchange="calculate_hours_total('+i.toString()+')" value='+on_data+'></td>';
                      html += '<td id="'+j+'-off"><input type="text" name="time'+j+'-off" id="time" class="time" onchange="calculate_hours_total('+i.toString()+')" value='+off_data+'></td>';
  ...
  function day_per_week(firtsday){
    ...
    day_w = fdate.getDay(),
    day_0 = fdate.getDate() - day_w,
    i, date, day;
    for(i=1;i<8;i++){
      day = day_0 + i;
      date = fdate.getMonth() + 1 + "/" + day + "/" + fdate.getFullYear();
